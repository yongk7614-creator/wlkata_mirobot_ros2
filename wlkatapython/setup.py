...
setup(
    ...
    version='0.1.1', # 包的版本号 #Package version number
    description='WLKATA-Mirobot/E4/MT4/Haro380/MS4220 Multiple robotic arm control!', # 描述信息 #Description information
