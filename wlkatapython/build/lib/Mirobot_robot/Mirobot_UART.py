...
class WLKATA_UART():
    ...
    def function_block(self,flag):
        self._block_flag =flag
...
class Mirobot_UART(WLKATA_UART):
    ...
    def writeangle(self, position, axle1=None, axle2=None, axle3=None, axle4=None, axle5=None, axle6=None):
        self.position = position
...
if __name__ == "__main__":
    robot = Mirobot_UART(block_flag=True,message_flag=True)
